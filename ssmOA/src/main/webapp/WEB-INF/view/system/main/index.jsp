...
<head>
    ...
    <link rel="stylesheet" href="${ctx}/resources/css/layuimini.css?v=2.0.4" media="all">
    <link rel="stylesheet" href="${ctx}/resources/css/themes/default.css" media="all">
...
<body class="layui-layout-body layuimini-all">
                ...
                <ul class="layui-nav layui-layout-right">
                    ...
                    <li class="layui-nav-item layuimini-setting">
                        ...
                        <dl class="layui-nav-child">
                            ...
                            <dd>
                                <a href="javascript:;" layuimini-content-href="${ctx}/resources/page/user-password.html" data-title="修改密码" data-icon="fa fa-gears">
                                    修改密码
                                </a>
                            </dd>
                            <dd>
    ...
    <script>
        layui.use(['jquery', 'layer', 'miniAdmin'], function () {
            ...
            var options = {
                iniUrl: "${ctx}/menu/loadIndexMenuJson.action",    // 初始化接口
